...
import { router } from 'expo-router'; import { api,establishSession } from '../src/api'; import { theme } from '../src/theme';
const periods = [
  ['monthly', 'Mensal'],
