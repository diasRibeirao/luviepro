import { ComponentProps,createContext,ReactNode,useCallback,useContext,useRef,useState } from 'react';
import { createPortal } from 'react-dom';
import Ionicons from '@expo/vector-icons/Ionicons';
import { Modal,Platform,Pressable,StyleSheet,type ViewStyle,useWindowDimensions,View } from 'react-native';
...
const s=StyleSheet.create({
  toastHost:{flex:1},
  webToastHost:{position:'fixed',top:0,left:0,right:0,bottom:0,zIndex:2147483647} as unknown as ViewStyle,
  webDialogHost:{position:'fixed',top:0,left:0,right:0,bottom:0,zIndex:2147483647} as unknown as ViewStyle,
