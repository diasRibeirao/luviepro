  ...
  return (
    <View style={s.field}>
      ...
      >
        <Text
          numberOfLines={1}
          style={[s.value,!selected&&s.placeholder]}
        >
        ...
        <Ionicons
          name="chevron-down"
          size={17}
          color={open?brand.primary:theme.muted}
        />
      </Pressable>
      ...
      >
        ...
        >
          <Pressable style={s.modal} onPress={()=>undefined}>
            ...
            >
              {options.length===0
                ?<Text style={s.empty}>Nenhuma opção disponível.</Text>
                :options.map(option=>{
...
const s=StyleSheet.create({
  ...
  backdrop:{
    flex:1,
    backgroundColor:'rgba(15,30,25,.42)',
    alignItems:'center',
