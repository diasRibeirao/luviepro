...
export type TenantData={name:string;logoUrl?:string|null;primaryColor?:string|null;secondaryColor?:string|null;document?:string|null;contactEmail?:string|null;phone?:string|null;addressLine?:string|null;addressNumber?:string|null;city?:string|null;state?:string|null;proposalText?:string|null;proposalPaymentTerms?:string|null;pixKey?:string|null;responsibleName?:string|null;siteUrl?:string|null;instagram?:string|null;proposalFooter?:string|null};
