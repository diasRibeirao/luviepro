...
import {PlatformBackupRecovery} from '../PlatformBackupRecovery';
import {PlatformTrialSettings} from '../PlatformTrialSettings';
...
export default function Platform(){
 ...
 {tab==='overview'?<Overview data={data} companies={companies} users={users} payments={payments} onTab={selectTab}/>:tab==='email'?<PlatformEmailSettings/>:tab==='maintenance'?<PlatformMaintenance onOpenClientUsers={()=>selectTab('users')}/>:tab==='health'?<PlatformHealth/>:tab==='backup'?<PlatformBackupRecovery/>:tab==='trial'?<PlatformTrialSettings/>:<>
