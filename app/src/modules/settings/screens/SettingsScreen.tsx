...
const s=StyleSheet.create({notice:{backgroundColor:theme.green50,borderWidth:1,borderColor:theme.border,borderRadius:13,paddingHorizontal:14,paddingVertical:12,flexDirection:'row',alignItems:'flex-start',gap:9,marginBottom:20},noticeNarrow:{paddingHorizontal:11,paddingVertical:10},noticeText:{flex:1,fontSize:12,lineHeight:18,color:theme.muted},noticeStrong:{fontWeight:'900',color:theme.ink},group:{marginBottom:24},groupHead:{marginBottom:10},groupHeadNarrow:{paddingHorizontal:2},groupTitle:{fontFamily:'serif',fontSize:18,fontWeight:'900',color:theme.ink},groupSubtitle:{fontSize:12,color:theme.muted,marginTop:3},grid:{flexDirection:'row',flexWrap:'wrap',gap:14,alignItems:'stretch'},gridCompact:{flexDirection:'column'},card:{width:'48%',minWidth:320,minHeight:112,backgroundColor:theme.white,borderWidth:1,borderColor:theme.border,borderRadius:15,padding:18,flexDirection:'row',alignItems:'center',gap:14,shadowColor:theme.shadow,shadowOpacity:.025,shadowRadius:10,shadowOffset:{width:0,height:3}},cardCompact:{width:'100%',minWidth:0},cardNarrow:{padding:14,minHeight:104,gap:11},pressed:{opacity:.72},icon:{width:44,height:44,borderRadius:12,backgroundColor:theme.green50,alignItems:'center',justifyContent:'center'},cardText:{flex:1,minWidth:0},titleRow:{flexDirection:'row',alignItems:'center',gap:8,flexWrap:'wrap'},title:{fontFamily:'serif',fontSize:17,fontWeight:'800',color:theme.ink},countBadge:{backgroundColor:theme.cream,borderRadius:999,paddingHorizontal:8,paddingVertical:4},countText:{fontSize:9,fontWeight:'900',color:theme.muted,textTransform:'uppercase'},subtitle:{fontSize:12,color:theme.muted,lineHeight:17,marginTop:5}});
