...
const checks=[
 ['imports useWindowDimensions',/import \{[^}]*useWindowDimensions[^}]*\} from 'react-native'/],
...
let fail=0;
console.log('v268.2 PlatformOverview responsive scope audit');
...
console.log('OK PlatformOverview narrow scope is complete');
