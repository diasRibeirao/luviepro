...
const checks=[
  ...
  ['composition copies team costs and stages', source.includes('const members=(service.team??[]).filter(member=>member.included!==false)')&&source.includes('selected.flatMap(service=>(service.costs??[])')&&source.includes('selected.flatMap(service=>(service.stages??[])')],
