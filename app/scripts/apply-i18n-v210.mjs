...
const entries=new Map([
  ["Não foi possível carregar o dashboard", ["Unable to load dashboard", "No fue posible cargar el dashboard"]],
  ["Operação em dia", ["Operation on track", "Operación al día"]],
  ["Atenção necessária", ["Attention needed", "Atención necesaria"]],
  ["Nenhuma pendência crítica agora", ["No critical issues right now", "No hay pendientes críticos ahora"]],
