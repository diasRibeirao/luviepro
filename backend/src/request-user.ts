...
export interface TenantPrincipal{sub:string;tenantId:string;role:TenantRole;plan?:string;customProfileId?:string|null;permissions?:string[];typ?:'access';sid?:string;}
