...
export function isPlanCode(value:string):value is PlanCode{return (PLAN_CODES as readonly string[]).includes(value);}
...
export function billingAction(currentPlan:string,targetPlan:string,expiresAt?:Date|null,now=new Date()):BillingAction{
