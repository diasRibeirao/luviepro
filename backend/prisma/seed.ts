...
async function main() {
  const plans=[
    {plan:'basic',name:'Basic',description:'Para começar com organização e controle essencial',active:true,sortOrder:10,maxClients:10,maxQuotesPerMonth:10,maxUsers:1,customPdf:false,logoPdf:true,premiumTemplates:false,projectManagement:'basic',advancedReports:false,exportData:false,standardRoles:false,customRoles:false,granularPermissions:false,auditAccess:false,monthlyPriceCents:6990,quarterlyPriceCents:18873,semiannualPriceCents:35649,annualPriceCents:67104},
    {plan:'starter',name:'Starter',description:'Para profissionais com operação em crescimento',active:true,sortOrder:20,maxClients:30,maxQuotesPerMonth:30,maxUsers:1,customPdf:false,logoPdf:true,premiumTemplates:false,projectManagement:'basic',advancedReports:false,exportData:false,standardRoles:false,customRoles:false,granularPermissions:false,auditAccess:false,monthlyPriceCents:9990,quarterlyPriceCents:26973,semiannualPriceCents:50949,annualPriceCents:95904},
    {plan:'pro',name:'Pro',description:'Para equipes que precisam de gestão completa e escala',active:true,sortOrder:30,maxClients:100,maxQuotesPerMonth:100,maxUsers:3,customPdf:true,logoPdf:true,premiumTemplates:false,projectManagement:'complete',advancedReports:true,exportData:false,standardRoles:true,customRoles:false,granularPermissions:false,auditAccess:false,monthlyPriceCents:11990,quarterlyPriceCents:32373,semiannualPriceCents:61149,annualPriceCents:115104},
    {plan:'business',name:'Business',description:'Para operações avançadas com alto volume e controle total',active:true,sortOrder:40,maxClients:-1,maxQuotesPerMonth:-1,maxUsers:10,customPdf:true,logoPdf:true,premiumTemplates:true,projectManagement:'kanban',advancedReports:true,exportData:true,standardRoles:true,customRoles:true,granularPermissions:true,auditAccess:true,monthlyPriceCents:14990,quarterlyPriceCents:40473,semiannualPriceCents:76449,annualPriceCents:143904},
  ];
